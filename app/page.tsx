  ...
  return (
    <section className="py-24 border-y border-white/5">
      <div className="mx-auto max-w-5xl px-6">
        <AnimateIn className="text-center mb-12">
          <p className="text-amber-400 text-xs font-bold tracking-[0.2em] uppercase mb-4">Why Qualix</p>
          <h2 className="text-4xl font-bold text-white tracking-tight mb-4">How we compare.</h2>
          <p className="text-white/40 text-base max-w-xl mx-auto">Manual review and Copilot help with the basics. Qualix goes the full distance.</p>
        </AnimateIn>
        <AnimateIn delay={100}>
            ...
            <div className="grid grid-cols-4 bg-white/5">
              ...
              <div className="p-5 text-center border-l border-b border-amber-500/15 bg-amber-500/5">
                <div className="flex items-center justify-center gap-1.5">
                  <LogoMark size={14} />
                  <p className="text-xs font-bold text-amber-400">Qualix</p>
                </div>
              </div>
            </div>
