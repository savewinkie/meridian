  ...
  return (
    ...
    >
      <div className="relative h-[68px] w-[68px]">
        <div className="absolute inset-2 rounded-full blur-lg opacity-30" style={{ backgroundColor: color }} />
    ...
    <div className="flex flex-col h-full bg-[#060b16]">
      ...
      >
        <div className="flex items-center gap-1.5 text-[11px] font-mono text-white/25">
          <Link
            href="/scanner"
            className="flex items-center gap-1 text-white/35 hover:text-white/60 transition-colors mr-1"
          >
          ...
          <ChevronRight className="h-3 w-3" />
          <span className="text-amber-400/70">code</span>
