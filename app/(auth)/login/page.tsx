      ...
      <div className="hidden lg:flex lg:w-[460px] flex-col justify-between p-12 relative overflow-hidden bg-[#070d1a] border-r border-white/[0.06]">
        ...
        >
          ...
          <blockquote className="text-white/70 text-[17px] leading-relaxed mb-6 font-light">
            "Qualix caught a critical security vulnerability in our auth flow that would have exposed user data. It paid for itself in the first week."
          </blockquote>
        ...
        <p className="relative text-[11px] text-white/20">© {new Date().getFullYear()} Qualix, Inc.</p>
      </div>
